  ...
  return (
    <div>
      <Mention>
        ...
        <p>
          Le site Internet www.everetrofit.fr, ci-après dénommé «
          EVeRetrofit.com » propose un service de rétrofit (transformation des
          véhicules thermiques en électriques) aux particuliers et aux
          entreprises. L&apos;accès au site, sa consultation et son utilisation
          sont subordonnés à l&apos;acceptation sans réserve des présentes
          Conditions Générales d&apos;Utilisation de EVeRetrofit.fr.
        </p>
        <p>
          Statut du propriétaire : société Préfixe : SAS Nom de la Société :
          EVeRetrofit SAS Adresse : HubInnovation, 11, Av. de l&apos;Harmonie,
          59650 Villeneuve-d&apos;Ascq Au Capital de : 15 000 €
        </p>
        <p>SIRET : XXXXXXXXXXXXXXXX R.C.S. : XXX XXX XXX R.C.S. LILLE</p>
        <p>Numéro TVA intracommunautaire : FRXXXXXXXXXXXXX</p>
        <p>Adresse de courrier électronique : contact@everetrofit.com</p>
        <p>Le Créateur du site est : Développé avec ♥ par les Wilders</p>
        <p>Le Responsable de la publication est : Anthony Tartare </p>
        <p>
          Contactez le responsable de la publication : contact@everetrofit.com
          Le responsable de la publication est une personne physique
        </p>
        <p>
          Le Webmaster est : Anthony Tartare Contactez le Webmaster :
          contact@everetrofit.com
        </p>
        <p>L’hebergeur du site est : OVH 2 rue Kellermann 59100 Roubaix</p>
        <h2>2. Description des services fournis :</h2>
        <p>
          Le site www.everetrofit.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
        </p>
        <p>
          Le proprietaire du site s’efforce de fournir sur le site
          www.everetrofit.com des informations aussi précises que possible.
        ...
        <p>
          Tous les informations proposées sur le site www.everetrofit.com sont
        ...
        <p>
          ...
          préalable à l’email : contact@everetrofit.com
        </p>
        <p>
        ...
        <p>
          Le site www.everetrofit.com contient un certain nombre de liens
        ...
        <p>
          ...
          www.everetrofit.com, un ou des cookies sont susceptible de s’installer
        ...
        <p>
          Sur le site www.everetrofit.com, le proprietaire du site ne collecte
          des informations personnelles relatives à l’utilisateur que pour le
          besoin de certains services proposés par le site www.everetrofit.com.
          ...
          précisé à l’utilisateur du site www.everetrofit.com l’obligation ou
        ...
        <p>
          ...
          www.everetrofit.com par email : email du webmaster ou en effectuant sa
        ...
        <p>
          ...
          www.everetrofit.com n’est publiée à l’insu de l’utilisateur, échangée,
          transférée, cédée ou vendue sur un support quelconque à des tiers.
          Seule l’hypothèse du rachat du site www.everetrofit.com à le
          proprietaire du site et de ses droits permettrait la transmission des
          ...
          vis à vis de l’utilisateur du site www.everetrofit.com.
        </p>
        <p>
          Le site www.everetrofit.com est en conformité avec le RGPD voir notre
          politique RGPD www.everetrofit.com/rgpd/.
        </p>
        <p>
